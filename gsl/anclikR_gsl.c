...
SEXP anclikR_gsl(SEXP s_dst, SEXP s_vst, SEXP s_s2_pr_alpha, SEXP s_s2_pr_beta){
  ...
  // NOTE: Could be done without allocating new memory by making dst, vst arrays of gsl_vector_view,
  //       but that would make anclik function less modular for future developments.
